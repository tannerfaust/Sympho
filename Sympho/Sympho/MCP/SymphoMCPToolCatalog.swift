...
enum SymphoMCPToolCatalog {
    ...
    private static var schemaCatalog:WorkspaceValue { .object([
        ...
        "track":.string("required title, domain_id; description, sort_index, emoji, icon_name (SF Symbol)"),
        "module":.string("required title and exactly one of track_id/domain_id; description, sort_index, emoji, icon_name (SF Symbol)"),
        "node":.string("required title; description, module_id, project_id, sort_index, status, priority, pinned, capture_intent, emoji, icon_name (SF Symbol)"),
        "project":.string("required title; description, domain_id, track_id, status, pinned, emoji, icon_name (SF Symbol)"),
        "glyph":.string("track/module/node/project accept emoji (single emoji) and/or icon_name (SF Symbol); setting one clears the other; emoji takes display precedence"),
